...
**how to run**: dotnet dev-certs https -ep "$env:APPDATA\ASP.NET\Https\Web.Api.pfx" -p "YourSecurePassword" then go to root folder and run docker-compose up -d --build<br>
